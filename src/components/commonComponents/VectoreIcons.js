...
import IconW6 from 'react-native-vector-icons/FontAwesome5';
import IconV from 'react-native-vector-icons/Fontisto';
import Icon123 from 'react-native-vector-icons/SimpleLineIcons';
    ...
    return (
        icon == "Feather" ?
            ...
            icon == "SimpleLineIcons" ?
                <Icon123 name={name} color={color} style={style} size={size} />
                :
                icon == "AntDesign" ?
                                        ...
                                        icon == "Ionicons" ?
                                            ...
                                            icon == "Octicons" ?
                                                ...
                                                icon == "FontAwesome5" ?
                                                    ...
                                                    :
                                                    icon == "FontAwesome6" ?
                                                        <IconW6 name={name} color={color} style={style} size={size} />
                                                        :
                                                        icon == "MaterialIcons" ?
